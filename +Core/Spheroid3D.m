classdef Spheroid3D < handle
    ...
    methods
        ...
        function findCenter(obj)
            ...
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            %% This part only active when HeLa spheroids show very low intensity inside %%
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            testmembrane = obj.channels.membrane;
            List = unique(testmembrane);
            testmembrane(testmembrane < List(2)) = 0;
            testmembrane(testmembrane >= List(2)) = 1;
            for i = 1:size(testmembrane, 3)
                testmembrane(:,:,i) = bwareaopen(testmembrane(:,:,i), 4);
            end
            se = strel('sphere', 3);
            testmembrane = imdilate(testmembrane, se);
            for i = 1:size(testmembrane, 3)
                testmembrane(:,:,i) = bwareaopen(testmembrane(:,:,i), 1500);
            end
            ...
            membrane(testmembrane == 1) = InnerDilation(testmembrane == 1);
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

            %%%%%%%%%%%%% Comment while working with HeLa spheroids %%%%%%%
            % se = strel('cube', 2);
