classdef Spheroid3D < handle
    ...
    methods
        ...
        function [Int] = getIntensityInside(obj)
            fr = 20;
        ...
        function findCenter(obj)
            ...
            obj.results.RefEllipsoid = refellipsoid;
        ...
        function CartToEllipsoid(obj)
            ...
            elseif ~exist(SpheroidSphFile)
                ...
                x = (SpheroidCart(:,1)-obj.results.RefEllipsoid.center(1,1)).';
                y = (SpheroidCart(:,2)-obj.results.RefEllipsoid.center(2,1)).';
                z = (SpheroidCart(:,3)-obj.results.RefEllipsoid.center(3,1)).';
            ...
            elseif ~exist(PartCartFile)
                ...
                for i = 3:size(PartList, 2) % remove 0 and 11 values
            ...
            elseif ~exist(PartSphFile)
                ...
                x = (PartCart(:,1)-obj.results.RefEllipsoid.center(1,1)).';
                y = (PartCart(:,2)-obj.results.RefEllipsoid.center(2,1)).';
                z = (PartCart(:,3)-obj.results.RefEllipsoid.center(3,1)).';
