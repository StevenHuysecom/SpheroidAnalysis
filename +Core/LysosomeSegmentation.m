classdef LysosomeSegmentation < handle
    ...
    methods
        ...
        function [Segment] = Segmentation(obj, Channel, ChannelName, Threshold)
            ...
            FigPath1 = append(obj.raw.path, filesep, 'mask_', ChannelName, 'Threshold_all0.30_.png');
            FigPath2 = append(obj.raw.path, filesep, 'mask_', ChannelName, 'Threshold_all0.30_.svg');
            saveas(Fig, FigPath1);
            saveas(Fig, FigPath2);
        end
        ...
        function [Results] = CalculatepH(obj)
            RatioMapRaw = obj.channels.mTFP1./obj.channels.mCherry;
            ...
            cb.Limits = [0 2];
            saveas(Fig, append(obj.raw.path, filesep, 'RatioMap.png'))
            saveas(Fig, append(obj.raw.path, filesep, 'RatioMap.svg'))
            ...
            SignalIn = sum(ParticleDensityInSide, 'all', 'omitnan');
            NPDensityIn = SignalIn./PxNum;
            ...
            SignalOut = sum(ParticleDensityOutSide, 'all', 'omitnan');
            NPDensityOut = SignalOut./PxNum;

            Results = [SignalInLysotracker, SignalOutsideLysotracker, NPDensityIn, NPDensityOut, SignalIn, SignalOut];
        end
    end
end
